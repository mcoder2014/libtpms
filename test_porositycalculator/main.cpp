...
//    parser.addVersionOption();          // --Version
    ...
    parser.addOption(porousPathOption);  // 添加选项到程序
    ...
    parser.addOption(boundaryPathOption);

    QCommandLineOption voxelsizeOption(QStringList() << "v" << "voxelsize");
    voxelsizeOption.setDefaultValue("0.1");
    parser.addOption(voxelsizeOption);
